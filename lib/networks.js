 ...
 * numbers for each cryptorescue network. Currently only supporting "livenet"
...
var TESTNET = {
  PORT: 18757,
  NETWORK_MAGIC: BufferUtil.integerAsBuffer(0x18242018),
  DNS_SEEDS: [
    'dnsseed.testnet.cryptorescue.org'
  ]
};
