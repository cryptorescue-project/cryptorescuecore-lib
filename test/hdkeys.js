...
var HDPrivateKey = cryptorescuecore.HDPrivateKey;
var HDPublicKey = cryptorescuecore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = cryptorescuecore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(cryptorescuecore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(cryptorescuecore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      cryptorescuecore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = cryptorescuecore.PublicKey.fromPoint;
      cryptorescuecore.PublicKey.fromPoint = function() {
        cryptorescuecore.PublicKey.fromPoint = unstubbed;
