...
var script_valid = require('../data/cryptorescued/script_valid');
var script_invalid = require('../data/cryptorescued/script_invalid');
var tx_valid = require('../data/cryptorescued/tx_valid');
var tx_invalid = require('../data/cryptorescued/tx_invalid');

//the script string format used in cryptorescued data tests
Script.fromcryptorescuedString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected) {
    var scriptSig = Script.fromcryptorescuedString(vector[0]);
    var scriptPubkey = Script.fromcryptorescuedString(vector[1]);
  ...
  describe('cryptorescued script evaluation fixtures', function() {
  ...
  describe('cryptorescued transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //cryptorescued casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromcryptorescuedString(scriptPubKeyStr);
          });
