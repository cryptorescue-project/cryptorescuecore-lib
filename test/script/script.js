...
describe('Script', function() {
  ...
  describe('#isPublicKeyIn', function() {
    it('correctly identify scriptSig as a public key in', function() {
      ...
      var script = cryptorescuecore.Script.fromBuffer(scriptBuffer);
  ...
  describe('#isPushOnly', function() {
    it('should know these scripts are or aren\'t push only', function() {
      ...
      // like cryptorescued, we regard OP_RESERVED as being "push only"
  ...
  describe('#buildWitnessMultisigOutFromScript', function() {
    it('it will build nested witness scriptSig', function() {
      var redeemScript = cryptorescuecore.Script();
      var redeemHash = cryptorescuecore.crypto.Hash.sha256(redeemScript.toBuffer());
  ...
  describe('toAddress', function() {
    ...
    it('works for p2pkh output', function() {
      ...
      script.toAddress().toString().should.equal('CYWfkpw6GJEuBDHUMKGmDBkaTUTXpQTwRU');
    });
  ...
  describe('#getSignatureOperationsCount', function() {
    // comes from cryptorescued src/test/sigopcount_tests
    ...
    it('should handle P2SH-multisig-in scripts from utility', function() {
      ...
      var signature = cryptorescuecore.crypto.Signature.fromString('30060201FF0201FF');
